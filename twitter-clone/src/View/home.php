...
<body>
    <div class="left">
        <h1>Home</h1>
        <ul>
            <li><a href="./profile/<?php echo $_SESSION['username']; ?>">Perfil</a></li>
    ...
    <div class="mid">
        ...
        <form id="postForm" action="./post" method="POST">
            ...
            <textarea
                name="content"
                id="postContent"
                placeholder="Qual é a novidade, @<?php echo $_SESSION['username']; ?>?"
                maxlength="280"
                required
            ></textarea>
                ...
                <?php foreach ($posts as $post): ?>
                    <div class="post-card">
                        ...
                        <div class="post-header">
                            <strong><a href="/profile/<?php echo htmlspecialchars($post['username']); ?>">
        ...
        <?php else: ?>
            <ul>
                <?php foreach ($trendingHashtags as $trendingHashtag): ?>
                    <li><a href="<?php echo "trends?hashtag=".htmlspecialchars($trendingHashtag); ?>"><?php echo htmlspecialchars($trendingHashtag); ?></a></li>
                <?php endforeach; ?>
            </ul>
        <?php endif; ?>
    </div>
