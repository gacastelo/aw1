<div class="mb-5">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
                ...
                <div class="card h-100 bg-light text-center border-dashed">
                    <div class="card-body d-flex align-items-center justify-content-center p-5">
                        <span 
                            ...
                            data-bs-target="#addFilmeModal"
                            style="width: 60px; height: 60px; line-height: 45px; border-radius: 50%; font-size: 2rem;">
                            +
                        </span>
                    </div>
        ...
        ?>
            <div class="col">
                <div onclick="openFilmeModal('<?php echo $modalId; ?>')" 
                class="card h-100 shadow-sm movie-card"
                style="cursor: pointer;">
                    <img 
                        src="<?= htmlspecialchars($filme->link_imagem) ?>" 
